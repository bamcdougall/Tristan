...
dat <- tbl_df(data.frame(
    ...
    size = factor(rep(c("30 Samples", "40 Samples", "50 Samples"), rep(1000, 3)))))
# dat <- tbl_df(data.frame(
#     x = c(apply(rnorm30.frame, 1, mean, 30),
#           apply(rnorm40.frame, 1, mean, 40),
#           apply(rnorm50.frame, 1, mean, 50)
#     ),
