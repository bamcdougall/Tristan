...
aprAnn = 0.125 #https://www.mysavingsdirect.com/MySavingsDirectWeb/en/common/information/LearnMore.jsp
...
finGrowthTblMnth <- finGrowthTblMnth%>%
    mutate(
        ...
        years = as.period( (dateClose - ymd_hms("2015-01-01 16:00:00", tz = "America/New_York") ) ) %/% months(12),
        quarters = as.period( (dateClose - ymd_hms("2015-01-01 16:00:00", tz = "America/New_York") ) ) %/% months(3),
        months = as.period( (dateClose - ymd_hms("2015-01-01 16:00:00", tz = "America/New_York") ) ) %/% months(1),
        days = as.period( (dateClose - ymd_hms("2015-01-01 16:00:00", tz = "America/New_York") ) ) %/% days(1),
